<?php require_once(realpath($_SERVER["DOCUMENT_ROOT"]).'/2006/Control/WithdrawFromConfirmedSession.php'); ?>
<?php session_start(); ?>
...
<header>
    ...
    <div class="menu_block ">
        <div class="container_12-fluid" >
            <div class="grid_12" style="margin-left: 12%">
...
<div class="content"><div class="ic"></div>
    <div class="container_12">
        <br>
        <h1 style="font-size: 30px">Confirmed Sessions</h1>
            <br>
            <?php
