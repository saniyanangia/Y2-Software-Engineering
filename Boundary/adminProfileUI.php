...
<?php session_start()?>
<!-- add session_start to each page the follows -->
<html>
<!--style stuff-->
<html lang="en">
<head>
            ...
            <div class="grid_12" style="margin-left: 13%">
                <nav class="horizontal-nav full-width horizontalNav-notprocessed">
                    <ul class="sf-menu">
                        ...
                        <li class="sf-menu"><a href="Admin_main.php">Main Page</a></li>
...
<!-- end of style stuff -->
<body>
    <!-- this page will show the user's profile -> this will be done by doing an sql call to the database with the user's username/gardenid, getting info, and then printing that info -->
    <div class="content"><div class="ic"></div>
    <div class="container_12" style = "font-family:'Marvel'">
        <h2> User Profile </h2>
        <h4>
        <?php
        displayProfilePage($_SESSION['ID'],$_SESSION['Type']); 
        // this displayProfilePage takes in the 2 session values declared in initialise.php -> check profile mgr for more details.
        ?>
        <br>
        <form method = "POST", action = ""> 
        <button type = "submit" class ='btn btn-success btn-lg' name = "edit">Edit Details</button>
        </form>
        <br>
        <form method = "POST", action = "Admin_main.php"> 
        <button type = "submit" class ='btn btn-success btn-lg' name = "return">Return to Main Page</button>
        </form>
        </h4>
        <?php
        if(isset($_POST['edit'])){
