<?php require_once(realpath($_SERVER["DOCUMENT_ROOT"]).'/2006/Control/WithdrawFromRequestedSession.php'); ?>
<?php session_start(); ?>
            ...
            <div class="grid_12">
                <nav class="horizontal-nav full-width horizontalNav-notprocessed">
                    <ul class="sf-menu">
                        ...
                        <li><a href="Volunteer_main.php">Main_Page</a></li>
...
<div class="content"><div class="ic"></div>
    <div class="container_12">
        <br>
        <h1 style="font-size: 30px" class="center">Requested Sessions</h1>        
            <br>
            <?php
