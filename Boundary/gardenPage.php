    ...
    <div class="container_12" >
      <div class="grid_12" style="margin-left: 13%">
        <nav class="horizontal-nav full-width horizontalNav-notprocessed">
          <ul class="sf-menu" style="margin: auto">
            <li><a href="Landing_page.html">Switch Account</a></li>
            <li class="sf-menu"><a href="Volunteer_main.html">User Profile</a></li>
...
<div class="content"><div class="ic"></div>
  <div class="container_12" style= "font-family:'Marvel'">
    ...
    echo "<br><p style='font-size: 50px; text-align: center; margin-left: 9%; width:800px'>Garden $gardenID</p>";
    retrieveGarden($gardenID);
    ?>
    <form action = 'BookSessionUI.php' method = 'POST'>
    <button class ='btn btn-success btn-lg' type='submit' name='ViewSessions' value='ViewSessions"'>View Available Sessions </button>
    </form>
    <br>
    <form action = "Gardens.php" method = 'POST'>
    <button class ='btn btn-success btn-lg' type='submit' name='return' value='return"'>Return to Previous Page</button>
    </form>
  </div>
</div>
