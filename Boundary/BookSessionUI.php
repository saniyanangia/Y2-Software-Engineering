            ...
            <div class="grid_12">
                <nav class="horizontal-nav full-width horizontalNav-notprocessed">
                    <ul class="sf-menu">
                        <?php 
                        if ($_SESSION['ID']){
                            echo"<li><a href='Landing_page.php?logout=true'>Logout</a></li>";
                            ...
                            echo"<li><a href='Landing_page.php'>Landing Page</a></li>";
...
<div class="content"><div class="ic"></div>
    ...
    <?php require_once(realpath($_SERVER["DOCUMENT_ROOT"]).'/2006/Control/BookSession.php') ?>;
        <br>
        <h1 style="font-size: 30px" class="center">Available Sessions</h1>
        <table class="imagetable" width="800" height="50" style="margin-left: 8%;">
            <!-- <br>
            <tr>
                <th><center><b style="font-size: 13px" >Time</b></th>
                <th><center><a style="font-size: 13px" href="#">20 Sep 2021</a></th>
                <th><center><a style="font-size: 13px" href="#">21 Sep 2021</a></th>
                <th><center><a style="font-size: 13px" href="#">22 Sep 2021</a></th>
                <th><center><a style="font-size: 13px" href="#">23 Sep 2021</a></th>
                <th><center><a style="font-size: 13px" href="#">24 Sep 2021</a></th>
